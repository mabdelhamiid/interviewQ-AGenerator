...
export const PROVIDER_INFO: Record<keyof ApiKeys, ProviderInfo> = {
  ...
  cerebras  : { label: 'Cerebras',      color: '#7C3AED', getKeyLink: 'https://cloud.cerebras.ai',                    placeholder: 'csk-...',           instructions: 'مجاني · أسرع inference في العالم' },
  ...
  together  : { label: 'Together.ai',   color: '#0EA5E9', getKeyLink: 'https://api.together.xyz/settings/api-keys',   placeholder: 'together-...',      instructions: 'free credits عند التسجيل'          },
...
export const EMPTY_KEYS: ApiKeys = {
  google: '', groq: '', openrouter: '', mistral: '', cohere: '',
  cerebras: '', together: '', anthropic: '', openai: '',
}
